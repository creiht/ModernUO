...
ModernUO features **58 skills** organized into four categories. Skills are the primary way characters develop capabilities beyond raw stats. Each skill has a minimum and maximum level, gain rates, and scaling relationships with core stats.

The skill cap system limits total skill points across all skills. The base cap is 7000 (70.00 in game terms), with bonuses available through veteran rewards and certain items. Skills can be locked (no gain), raised, or lowered, allowing character optimization and specialization.

## Categories

### Crafting Skills — 10 skills
Skills used to create items, modify equipment, and process resources.

- [Crafting Skills](crafting-skills.md) — Overview and skill table
...
Skills that directly affect offensive and defensive capabilities in combat.

- [Combat Skills](combat-skills.md) — Overview and skill table
...
### Magical Skills — 8 skills
Skills related to spellcasting and magical abilities, including spell schools.

- [Magical Skills](magical-skills.md) — Overview and skill table
...
### Utility Skills — 29 skills
Support skills for detection, navigation, crafting assistance, and quality of life.

- [Utility Skills](utility-skills.md) — Overview and skill table
- [Anatomy](anatomy.md) — Increase damage against creatures
- [Animal Lore](animallore.md) — Identify creatures and gather information
- [Animal Taming](animaltaming.md) — Capture and tame wild creatures
- [Arms Lore](armslore.md) — Enhance weapon effectiveness
- [Begging](begging.md) — Receive gold or items from NPCs as alms
- [Camping](camping.md) — Enhance wilderness survival
- [Detect Hidden](detecthidden.md) — Reveal invisible creatures and traps
- [Discordance](discordance.md) — Increase creature aggression
- [Fishing](fishing.md) — Catch fish and aquatic creatures
- [Forensics](forensics.md) — Investigate crime scenes
- [Healing](healing.md) — Restore hit points to creatures
- [Herding](herding.md) — Control and move groups of tamed animals
- [Hiding](hiding.md) — Conceal yourself from view
- [Item ID](itemid.md) — Identify properties of unidentified items
...
- [Remove Trap](removetrap.md) — Disarm traps in dungeons
- [Snooping](snooping.md) — Search containers for items
- [Spirit Speak](spiritspeak.md) — Channel energy from corpses to heal
- [Stealing](stealing.md) — Take items from other creatures
- [Stealth](stealth.md) — Move quietly while hidden
- [Taste ID](tasteid.md) — Identify food and drink properties
...
- **Locks**: Skills can be Raised, Locked, or Lowered
- **Gain Rates**: Each skill has unique gain chances based on skill level and target level
- **Stat Scaling**: Many skills scale with Str/Dex/Int differently
